...
print(valid_prompt("Tell me about bulldozers?", "anthropic.claude-3-haiku-20240307-v1:0"))  

print(valid_prompt("What was the mission of the Apollo 11 mission?", "anthropic.claude-3-haiku-20240307-v1:0"))